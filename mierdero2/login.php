...
<!--aqui acaba lo del php -->
    ...
    <seccion class="secciondecontenido dark">
      <div class="contenidodetexto">
        ...
        <p>
          En SIMUS.MJN, nuestro proposito es desarrollar softwares inclusivos que empodere a los niños, facilitando 
        ...
        <ul>
          <li> Promocionar softwares intuitivos que responda a las necesidades de aprendizaje de los niños</li>
    ...
    <seccion class="secciondecontenido">
      ...
      <div class="contenidodetexto">
        ...
        <p>
          Nuestro software emblema incorpora el diseño de interfaces accesibles para crear una experiencia única.
        </p>
        <ul>
    ...
    <piedepagina>
      <div class ="contendidodelpie">
        <div class="columnadelpie">
          <h3>SIMUS.MJN</h3>
          <p> Softwares inclusivos que combinan aprendizaje, comunicación y diversión.</p>
        </div>
        <div class="columnadelpie">
          <h3>Recursos</h3>
